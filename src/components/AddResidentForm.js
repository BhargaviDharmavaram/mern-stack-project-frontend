...
//         {role === 'pg_admin' && (
//           <div>
//             <h2>{isEditingMode ? 'Edit Resident' : 'Add Resident'}</h2>
...
//               {formErrors.profileImage && <p style={{ color: 'red' }}>{formErrors.profileImage}</p>}
//               {isEditing && profileImage && <img src={`http://localhost:3800/images/${profileImage}`} alt="Profile" width="100" height="100" />}
//               <br />
...
//               {formErrors.guardianName && <p style={{ color: 'red' }}>{formErrors.guardianName}</p>}
//               <br />
//               <label>Guardian Number <span style={{ color: 'red' }}>*</span></label>
//               <br />
//               <input type="text" name="guardianNumber" value={guardianNumber} onChange={handleInputChange} />
//               {formErrors.guardianNumber && <p style={{ color: 'red' }}>{formErrors.guardianNumber}</p>}
//               <br />
...
//               {formErrors.aadharCard && <p style={{ color: 'red' }}>{formErrors.aadharCard}</p>}
//               {isEditingMode && aadharCard && <img src={`http://localhost:3800/images/${aadharCard}`} alt="Aadhar" width="100" height="100" />}
//               <br />
//               <label>Select Room: <span style={{ color: 'red' }}>*</span> </label> 
//               <select name="roomId" value={roomId} onChange={handleInputChange}> 
...
//                 ))}
//               </select>
//               {formErrors.roomId && <p style={{ color: 'red' }}>{formErrors.roomId}</p>}
//               <br />
...
//                   color: 'white',
//                   border: 'none',
//                 }} value={isEditing ? 'Edit Resident' : 'Add Resident'} />
//             </form>
            ...
            <div className="card" style={{
                ...
                <div className="card-body">
                    ...
                    <div className="mb-3">
                        ...
                        <img src={`http://localhost:3800/images/${profileImage}`} alt="Profile" width="100" height="100" />
                        )}
                    </div>
                    <div className="mb-3">
                        <label className="form-label">
                    ...
                    <div className="mb-3">
                        ...
                        <img src={`http://localhost:3800/images/${aadharCard}`} alt="Aadhar" width="100" height="100" />
                        )}
                    </div>
                    <div className="mb-3">
                        <label className="form-label">
